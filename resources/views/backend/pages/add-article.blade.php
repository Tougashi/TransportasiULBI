        ...
        <div class="card-body">
            <form action="{{url()->current().'/store'}}" method="POST">
                ...
                <div class="form-group pb-1">
                    ...
                    <input type="text" name="title" class="form-control" id="judulArtikel" placeholder="Judul Postingan / Artikel">
                </div>
                <div class="form-group pb-1">
                    <label class="col-form-label" for="slugArtikel">Slug</label>
                    <input type="text" name="slug" class="form-control" disabled id="slugArtikel" placeholder="Slug Postingan / Artikel">
                </div>
                <div class="form-group pb-1">
                    <label class="col-form-label" for="bodyArtikel">Isi Artikel</label>
                    <input type="text" name="body" class="form-control" id="bodyArtikel" placeholder="">
                </div>
                <div class="row w-100">
...
@push('scripts')
    <script>
        ...
        ClassicEditor
            .create( document.querySelector( '#bodyArtikel' ) )
            .catch( error => {
                console.error( error );
            } );
    </script>
