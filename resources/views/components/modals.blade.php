    ...
    <div class="modal-lg modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    <li class="my-3">Tata Guna Lahan & Industri: mata kuliah ini membahas mengenai pengembangan tata
                        ...
                        lahan dan industri membutuhkan layanan dan karakteristik transportasi tang berbeda-beda </li>
                    <li class="my-3">Geografi Transportasi: mata kuliah ini membahas mengenai kondisi geografi yang
                        ...
                        mudah dan efektif</li>
                    <li class="my-3">Manajemen Rekayasa Lalu Lintas: mata kuliah ini membahas mengenai manajemen dan
                        ...
                        dampak lalu lintas dan perencanaan & pemodelan transportasi.</li>
                    <li class="my-3">Perencanaan & Pemodelan Transportasi: mata kuliah ini membahas mengenai hubungan
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    <li class="my-3">Analisis Biaya & Tarif Transportasi: mata kuliah ini membahas mengenai pengertian
                        ...
                        pemahaman tentang konsep-konsep yang berhubungan dengan biaya & tarif transportasi.</li>
                    <li class="my-3">Manajemen Bisnis Transportasi: mata kuliah ini membahas mengenai pengetahuan dan
                        keahlian tentang manajemen, kepemimpinan, manajemen sumber daya manusia, dan operasional. Lebih
                        fokus pada mempelajari sisi analisis, perencanaan, dan operasi bisnis.</li>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    <li class="my-3">Sistem Operasi Prasarana Bandar Udara: mata kuliah ini membahas konsep dasar
                    ...
                    <li class="my-3">Manajemen Operasi Sarana Truk: mata kuliah ini membahas mengenai konsep dan
                        ...
                        lancar antara operator dan pengirim barang. </li>
                    <li class="my-3">Manajemen Operasi Sarana Kereta Api: mata kuliah ini membahas mengenai sistem
                        ...
                        organisasi perkeretaapian hingga terkait trend inovasi perkeretaapian </li>
                    <li class="my-3">Manajemen Operasi Sarana Laut: mata kuliah ini membahas mengenai konsep dan
                        metode yang digunakan untuk mengelola operasi dan pengiriman barang dengan menggunakan sarana
                        transportasi laut (kapal) yang hemat biaya. </li>
                    <li class="my-3">Manajemen Operasi Sarana Udara: mata kuliah ini membahas mengenai konsep dan
                        metode yang digunakan untuk mengelola operasi dan pengiriman barang dengan menggunakan sarana
                        transportasi udara (pesawat) yang hemat biaya. </li>
                    <li class="my-3">Sistem Distribusi: mata kuliah ini membahas mengenai definisi, lingkup dan teori
                        ...
                        manajemen distribusi terpadu</li>
                    <li class="my-3">Supply Chain Management: mata kuliah ini membahas mengenai konsep dan metode yang
                        ...
                        harian, operasi, logistik dan pengolahan informasi mulai dari pelanggan hingga ke pemasok</li>
                    <li class="my-3">Manajemen Postal: adalah disiplin ilmu yang berkaitan dengan pengumpulan
                        ...
                        of origin) ke titik tujuan (point of destination)</li>
                </ol>
            </div>
        </div>
    </div>
